...
public class Log_In extends JFrame implements KeyListener {
    ...
    private void initComponent() {
        ...
        this.setLocationRelativeTo(null); // Căn vị trí cửa số của Jfram, JDialog,.. null | căn giữa, 1 component nào đó | Căn giữa cái đó
    ...
    public void keyPressed(KeyEvent e) {
        if (e.getKeyCode() == KeyEvent.VK_ENTER) {
            try {
                ...
                Logger.getLogger(Log_In.class.getName()).log(Level.SEVERE, null, ex); // Bắt ngoại lệ Lool And Feel trường hợp phiên bản đang chạy không hỗ trợ flatform
            }
        }
    }
